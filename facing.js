//#region TEMPLATE
const facing_template = document.createElement('template');
facing_template.innerHTML = /*html*/`
  <style>
...
EYE rotation <input id="reL" type="range" id="RL" min="-10" max="5" step="1" value="-8"></input><input id="reR" type="range" id="RL" min="-5" max="10" step="1" value="8"></input><br>
BROW height <input id="b_L" type="range" orient="vertical" id="RL" min="0" max="170" step="1" value="100"></input><input id="b_R" type="range" orient="vertical" id="RL" min="0" max="170" step="1" value="100"></input>
<svg version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
    ...
    <g id="I_L" transform="translate(0,-10)">
        <g id="Ir_L" transform="rotate(-8,820,3410)">
            ...
            <!-- pupil L -->
            <path id="pupil_L" class="st2" d="M905.9,3148.1c9.1-50-14.1-96-51.8-102.8c-37.7-6.8-75.5,28.2-84.6,78.1s14.1,96,51.8,102.8
